...
const StudentHeader = () => {
  return (
    <div className='w-full h-16 flex items-center px-2 gap-10'>
      ...
      <AddModal title='Add Student' triggerText='Add Student' className='hover:scale-105 transition-transform duration-200 bg-[#FAF9F6] w-fit p-2 rounded-lg text-black'>
        <StudentAdd />
      </AddModal>
    </div>
  );
